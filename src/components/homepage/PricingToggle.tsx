      ...
      <div className="mx-auto mt-14 grid max-w-3xl gap-6 sm:grid-cols-2">
        <div className="flex flex-col rounded-3xl border border-border bg-card p-9">
          ...
          <Button
            ...
            nativeButton={false}
            variant="outline"
            className="h-auto bg-muted px-5 py-2.5 text-sm font-semibold hover:bg-[color-mix(in_oklch,var(--muted),var(--foreground)_5%)]"
          >
            Get Started Free
          </Button>
        </div>
        ...
        <div className="relative flex flex-col rounded-3xl border border-[#6366f1] bg-linear-to-b from-[#6366f1]/8 to-card p-9 shadow-2xl">
          ...
          <GradientButton href="/register" className="px-5 py-2.5 text-sm font-semibold">
            Start Free Trial
          </GradientButton>
        </div>
      </div>
