# Synapse Homepage Mockup Spec

Create a marketing homepage for Synapse - a developer knowledge hub for code snippets, AI prompts, commands, notes, files, images, and links.
...
A box labeled "...with Synapse" showing a simplified dashboard mockup:
